	...
	<div>
		<div class="register-container">
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__backInDown" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot+Vue的数码产品购物商城的设计与实现注册</div>
...
export default {
	...
	methods: {
		...
		login() {
			...
			if((!this.ruleForm.yingyeshijian) && `shangjia` == this.tableName){
			...
			if((!this.ruleForm.yingyezhizhao) && `shangjia` == this.tableName){
