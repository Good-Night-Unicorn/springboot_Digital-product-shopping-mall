		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">店铺地址</label>
						<el-input v-model="searchForm.dianpudizhi" placeholder="店铺地址" @keydown.enter.native="search()" clearable></el-input>
					</div>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' prop="yingyezhizhao" label="营业执照">
						<template slot-scope="scope">
		...
		methods: {
			...
			chatClick(row) {
				...
				if(row.dianpumingcheng){
					this.nowname = row.dianpumingcheng
				}
