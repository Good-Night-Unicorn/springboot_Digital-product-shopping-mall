	...
	<div class="addEdit-block">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item v-else class="input" label="折扣价格" prop="discountprice" >
				...
				<el-form-item v-else class="input" label="折扣总价格" prop="discounttotal" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="dianpumingcheng" >
					<el-input v-model="ruleForm.dianpumingcheng" placeholder="商户名称" clearable  :readonly="ro.dianpumingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="商户名称" prop="dianpumingcheng" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springbootg47d9qwc/upload');
					} else {
