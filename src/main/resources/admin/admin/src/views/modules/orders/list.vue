			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"padding":"10px","margin":"0","flexWrap":"wrap","background":"#fff","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="success" @click="dayNumberChartDialog()">
						<span class="icon iconfont icon-xiaoliang19" :style='{"margin":"0 2px","fontSize":"14px","color":"#5BAAFF","height":"34px"}'></span>
						日销量
					</el-button>
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="success" @click="monthNumberChartDialog()">
						<span class="icon iconfont icon-xiaoliang4" :style='{"margin":"0 2px","fontSize":"14px","color":"#5BAAFF","height":"34px"}'></span>
						月销量
					</el-button>
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'季销量')" type="success" @click="quarterNumberChartDialog()">
						<span class="icon iconfont icon-xiaoliang6" :style='{"margin":"0 2px","fontSize":"14px","color":"#5BAAFF","height":"34px"}'></span>
						季销量
					</el-button>
					...
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="success" @click="goodtypeNumberChartDialog()">
						<span class="icon iconfont icon-xiaoliang11" :style='{"margin":"0 2px","fontSize":"14px","color":"#5BAAFF","height":"34px"}'></span>
						类型销量
					</el-button>
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="success" @click="dayAmountChartDialog()">
						<span class="icon iconfont icon-kuaijiezhifu" :style='{"margin":"0 2px","fontSize":"14px","color":"#5BAAFF","height":"34px"}'></span>
						日销额
					</el-button>
