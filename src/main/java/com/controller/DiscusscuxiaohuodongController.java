...
public class DiscusscuxiaohuodongController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discusscuxiaohuodong,deSens);
    ...
    public R save(@RequestBody DiscusscuxiaohuodongEntity discusscuxiaohuodong, HttpServletRequest request){
        ...
        return R.ok().put("data",discusscuxiaohuodong.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscusscuxiaohuodongEntity discusscuxiaohuodong = discusscuxiaohuodongService.selectOne(new EntityWrapper<DiscusscuxiaohuodongEntity>().eq("", username));
        return R.ok().put("data", discusscuxiaohuodong);
    }
    ...
    public R update(@RequestBody DiscusscuxiaohuodongEntity discusscuxiaohuodong, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discusscuxiaohuodong);
        //全部更新
        discusscuxiaohuodongService.updateById(discusscuxiaohuodong);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscusscuxiaohuodongEntity discusscuxiaohuodong, HttpServletRequest request,String pre){
        EntityWrapper<DiscusscuxiaohuodongEntity> ew = new EntityWrapper<DiscusscuxiaohuodongEntity>();
